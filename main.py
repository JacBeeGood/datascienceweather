...
st.write("This graph shows how tempeture and humidity stay similar and sometimes differ. You can see very small adjustments in humidity and very big adjustments in temperature. More humidity means rain and snow making it colder.")
